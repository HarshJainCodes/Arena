...
public class PM : MonoBehaviour
{
    ...
    private InfimaGames.LowPolyShooterPack.CharacterBehaviour playerCharacter;

    private InfimaGames.LowPolyShooterPack.WeaponBehaviour equippedWeapon;
    ...
    private void Awake()
    {
        playerCharacter = InfimaGames.LowPolyShooterPack.ServiceLocator.Current.Get<InfimaGames.LowPolyShooterPack.IGameModeService>().GetPlayerCharacter();
    }
